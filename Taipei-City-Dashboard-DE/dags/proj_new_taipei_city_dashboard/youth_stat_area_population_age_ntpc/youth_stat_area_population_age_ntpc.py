...
FALLBACK_RESOURCE_URL = (
    ...
    "6E03CA29B955A854D8F52522E38D8C7051A1FBDBAA621E921CCAA2C5A4BD546BD98169DD320C3EF6DBC4DE80A46DEC5BF5F23516"
)
...
def fetch_records():
    with requests.Session() as session:
        url = fetch_data_gov_resource(
            session,
            DATASET_ID,
            description_contains="新北市統計區五歲年齡組性別人口統計_二級發布區",
...
def transform_records(columns, rows, source_url, data_time=None):
    return build_stat_area_population_data(
        columns,
        rows,
...
def _transfer(**kwargs):
    ...
    print(f"stat area population ready_data shape =========== {data.shape}")
...
dag = CommonDag(
    ...
    dag_folder="youth_stat_area_population_age_ntpc",
)
